const ErrorCodes = {
    ...
    235: 'SMTP Error: Authentication successful.',
    ...
    252: 'SMTP Error: The server cannot verify the user, but it will try to deliver the message anyway.',
    334: 'SMTP Error: A response to the AUTH command, indicating that the client should send the username and password in the specified format.',
    ...
    521: 'SMTP Error: The domain does not accept mail from this sender.',
    530: 'SMTP Error: Authentication required.',
